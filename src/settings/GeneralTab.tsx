...
export function GeneralTab({
  ...
  return (
    <>
      ...
      <div className="setting-group">
        <SettingRow icon={RefreshCw} label="Restart Bloom" desc="Reinitialize all components" action onClick={restartBloom} />
        <SettingRow icon={LogOut} label="Quit Bloom" desc="Exit application completely" action danger onClick={quitBloom} divider={false} />
      </div>
    </>
  );
}
